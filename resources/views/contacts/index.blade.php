        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <div class="navbar-nav pl-2">
                <ol class="breadcrumb p-0 m-0 bg-white">
                    <li class="breadcrumb-item"><a href="categories.html">Contact Managment</a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="text-danger w-4 h-4 mr-1" onclick="event.preventDefault(); deleteContact('{{ $contact->id }}');">
