                ...
                <div class="container-fluid my-2">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{route('leads.index')}}" class="btn btn-primary">List</a>
                        </div>
                ...
                <div class="container-fluid">
                    <form action="{{ route('leads.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="value" id="value" class="form-control" value="{{ old('value') }}" step="0.01" placeholder="Lead Value">
                                            @error('value')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="notes" id="notes" class="form-control" placeholder="Add any notes here...">{{ old('notes') }}</textarea>
                                            @error('notes')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <!-- <a href="{{ route('leads.index') }}" class="btn btn-outline-secondary ml-2">Cancel</a> -->
                        </div>
                    </form>
