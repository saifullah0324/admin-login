                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="contact_id" id="contact_id" class="form-control">
                                                ...
                                                <option value="{{ $contact->id }}" {{ $lead->contact_id == $contact->id ? 'selected' : '' }}>
                                                    {{ $contact->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="status" id="status" class="form-control" value="{{ $lead->status }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="value" class="form-label">Value</label>
                                            <input type="number" name="value" id="value" class="form-control" value="{{ $lead->value }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
