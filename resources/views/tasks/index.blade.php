        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <div class="navbar-nav pl-2">
                <ol class="breadcrumb p-0 m-0 bg-white">
                    <li class="breadcrumb-item"><a href="categories.html">Tasks Managment</a></li>
                ...
                <div class="container-fluid my-2">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{route('tasks.create')}}" class="btn btn-primary">Add Contact</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="text-danger w-4 h-4 mr-1" onclick="event.preventDefault(); deleteContact('{{ $task->id }}');">
                                                <form id="delete-form-{{ $task->id }}" action="{{ route('tasks.destory', $task->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
